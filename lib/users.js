...
getAvatarUrl = function(user){
  return Gravatar.imageUrl(user.emails[0].address, {s:'150',d:'http://mallorcaworkshops.org.s3.amazonaws.com/gears.png'})
}
...
addProfileImg = function(user,url) {
  var $set = {};
  $set['profile.profileImg'] = url;
